...
This project is indexed by GitNexus as **GitNexus** (28628 symbols, 44719 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
